...
<form action="" method="POST" enctype="multipart/form-data">
    <input type="file" name="myfile" id="myfile" accept="image/*"><!-- 단일업로드 -->
...
$singlefile = $_FILES['myfile']; //단일 
$file = $_FILES['multifile'];//다중 (multiful)

$uploaddir = "upload/"; //경로 

echo "단일 <br/>";
print_r("파일 이름 : " . $singlefile['name']); //파일 이름 
echo "<br>";
print_r("파일 크기 : " . $singlefile['size'] . "KB");  //파일 크기 
echo "<br>";
print_r("파일 타입 : " . $singlefile['type']); //파일 타입
echo "<br>";
print_r("경로 : " . $singlefile['full_path']); //파일 경로 
echo "<br>";
print_r("tmp : " . $singlefile['tmp_name']); // tmp폴더에 임의의 이름으로 저장되고 사용이 끝나면 삭제된다. 
echo "<hr/>";
...
//단일 파일 업로드 
// $singleFile = $fileClass->singleFileUplaod($singlefile , $uploaddir ,  $fileClass::IMAGE_USE , false); 
// $fileClass->data_log($singleFile);
// singleFileUpload(파일객체 , 경로  , 업로드할 파일 타입(check타입) ,  uuid 사용여부(default = false));

//다중 파일 업로드 (multiful type)
// $file = "test";
// $multifulFile = $fileClass->multifulFileUpload($file, $uploaddir , $fileClass::IMAGE_USE, false );
// $fileClass->data_log($multifulFile);
// multifulUpload(배열(key이름마다 value는 배열로 이루어져있음) , 경로 ,  업로드할 파일 타입(check타입) , uuid 사용여부(defalt = false))

//압축해서 파일 다운로드
// $obj = new stdClass;
// $obj->path = "uplo";
// $obj->file = array("2023_05_25_102507_sample_images_03.png" , "2023_05_25_102507_sample_images_02.png");
// $obj = array("upload/2023_05_25_102507_sample_images_03.png" , "upload/2023_05_25_102507_sample_images_02.png");
...
// 연속 다운로드 (파일명만 있을경우)
// $fileArray = array(
//     "/2023_05_24_173702_sample_images_01.png",
//     "upload/2023_05_24_173702_sample_images_02.png",
//     "upload/2023_05_24_173702_sample_images_03.png",
// );
...
// $obj = new stdClass;
// $obj->path = "";
// $obj->file = array("test/upload/2023_05_24_171746_sample_images_01.png" , "test/upload/2023_05_24_171746_sample_images_02.png");
// $obj = array("2023_05_24_171746_sample_images_01.png" , "2023_05_24_171746_sample_images_02.png");
// $fileClass->zipDownload($obj); 
...
// $test = $fileClass->zipUpload($file , $uploaddir);
// $fileClass->data_log($test);
...
//     //파일 추가하기 
//     $zip->addFile($uploaddir . "2023_05_24_171746_sample_images_01.png" , "2023_05_24_171746_sample_images_01.png");
//     //원본파일(경로포함) , 압축파일내 저장할 파일 이름 
//     $zip->addFile($uploaddir . "2023_05_24_171746_sample_images_02.png", "2023_05_24_171746_sample_images_02.png");
//     //원본파일(경로포함) , 압축파일내 저장할 파일 이름 
...
//파일 삭제
$file = array("2023_05_24_183105_sample_images_03.png");
// $file = array();
$path = "upload/";
$fileClass->deleteFile($file , $path);
//파일 삭제
...
<script>
    ...
    uploadButton.addEventListener("click" , function(){
        ...
        var test = [
        "2023_05_24_173702_sample_images_01.png",
        "2023_05_24_173702_sample_images_02.png",
        "2023_05_24_173702_sample_images_03.png",
        ];
