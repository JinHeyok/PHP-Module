...
<?php
    ...
    //단일 파일 업로드 
    // $test = $fileClass->singleFileUplaod($singlefile , $uploaddir ,  $fileClass::IMAGE_USE , false); 
    // $fileClass->data_log($test);
    // singleFileUpload(파일객체 , 경로  , 업로드할 파일 타입(check타입) ,  uuid 사용여부(default = false));

    //다중 파일 업로드 (multiful type)
    // $file = "test";
    // $test = $fileClass->multifulFileUpload($file, $uploaddir , $fileClass::IMAGE_USE, false );
    // $fileClass->data_log($test);
    ...
    // $obj = new stdClass;
    // $obj->path = "upload/";
    // $obj->file = array("2023_05_24_183105_sample_images_01.png" , "2023_05_24_183105_sample_images_02.png");
    // $obj = array("upload/2023_05_24_183105_sample_images_01.png" , "upload/2023_05_24_183105_sample_images_02.png");
...
<!-- 단일 다운로드 -->
<a href="<?=$uploaddir . "2023_05_24_173702_sample_images_03.png"?>" download>test</a>
<!-- 단일 다운로드  -->
